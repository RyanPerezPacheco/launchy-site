...
export function Urgency() {
  const [filled, setFilled] = useState(20);
  useEffect(() => {
      ...
      <div className="wrap">
        <div className="urgency">
          <div>
            ...
            <p style={{ color: "var(--fg-3)", fontSize: 15, lineHeight: 1.5, maxWidth: "60ch" }}>
  ...
  return (
    <section className="final">
      <div className="wrap">
        ...
        <a href="/auth.html" className="btn btn-primary btn-lg">
