...
import { Hero, Pain, Solution, Benefits, Providers } from './components/Sections'
import { SocialProof, Offer, Objections, Guarantee, Urgency, FAQ, FinalCTA } from './components/Sections2'
    ...
    <header className="nav">
      <div className="wrap nav-row">
        ...
        <div className="nav-cta">
          <a href="/auth.html" className="btn btn-ghost btn-sm">
            Entrar
          </a>
          <a href="/auth.html" className="btn btn-dark btn-sm">
            Criar conta <span className="arr">→</span>
          </a>
        </div>
      </div>
    </header>
