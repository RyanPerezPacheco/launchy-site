        ...
        <div className="cta-block">
          ...
          {!submitted ? (
            ...
            <div className="success-box">
              ...
              <button onClick={() => { setSubmitted(false); setData({ nome: "", email: "", whatsapp: "", estagio: "", consent: false }); }} className="btn btn-ghost btn-sm" style={{ marginTop: 16 }}>
                Cadastrar outro
              </button>
            </div>
          )}
...
window.FounderForm = FounderForm;
